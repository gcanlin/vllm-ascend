...
from vllm_ascend.utils import vllm_version_is  # noqa: F401

# `expert_map_manager` (vllm PR #41046) only landed in v0.21.1rc0; on v0.20.2
# and v0.21.0 the function still lives in `fused_moe.layer`.
try:
